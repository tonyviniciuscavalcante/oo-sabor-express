...
# 3. Adicione um método de instância chamado emprestar à classe Livro que define o atributo disponivel como False. Crie uma instância da classe,
# chame o método emprestar e imprima se o livro está disponível ou não.
def emprestar(self):
...
# from exercicios.exercicio-04 import Livro  # Certifique-se de corrigir o nome do arquivo para o correto
